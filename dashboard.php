...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && ($_POST['form'] ?? '') === 'service_action') {
...
<head>
  ...
  <style>
    ...
    button { padding: .65rem .75rem; border-radius: 8px; border: 1px solid #d1d5db; font-size: 1rem; border: none; background: #2563eb; color: white; cursor: pointer; }
